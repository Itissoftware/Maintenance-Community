...
public class RegisterActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialog = new Dialog(RegisterActivity2.this, R.style.FullHeightDialog);
        ...
        btn_reg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(name) || TextUtils.isEmpty(email) || TextUtils.isEmpty(pass) || TextUtils.isEmpty(company)) {
                    ...
                    registerByServer(name, lastName, email, phone, address, token, company, pass);
                }
    ...
    private void registerByServer(String name, String lastname, String email, String phone, String address, String regid, String company, String pass) {
        ...
        Call<Register> userCall = service.getRegister(name, lastname, email, phone, address, regid, company, pass);
                ...
                .addOnCompleteListener(RegisterActivity2.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (!task.isSuccessful()) {
                            new LovelyInfoDialog(RegisterActivity2.this) {
                                @Override
