...
public class KnowledgeRecyclerAdapter extends RecyclerView.Adapter<KnowledgeRecyclerAdapter.ContactViewHolder> {

    Context context;
    String[] str;
    public static OnItemClickListener mItemClickListener;

    public KnowledgeRecyclerAdapter(Context context, String[] str) {
