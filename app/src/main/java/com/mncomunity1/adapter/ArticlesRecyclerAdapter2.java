...
public class ArticlesRecyclerAdapter2 extends RecyclerView.Adapter<ArticlesRecyclerAdapter2.ContactViewHolder> {

    Context context;
    ArrayList<Post> list = new ArrayList<>();
    public static OnItemClickListener mItemClickListener;

    public ArticlesRecyclerAdapter2(Context context, ArrayList<Post> list) {
