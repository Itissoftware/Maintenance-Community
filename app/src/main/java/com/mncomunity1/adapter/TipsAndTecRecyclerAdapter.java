...
public class TipsAndTecRecyclerAdapter extends RecyclerView.Adapter<TipsAndTecRecyclerAdapter.ContactViewHolder> {

    Context context;
    ArrayList<Post> list = new ArrayList<>();
    public static OnItemClickListener mItemClickListener;

    public TipsAndTecRecyclerAdapter(Context context, ArrayList<Post> list) {
    ...
    public ContactViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View itemView = LayoutInflater.
                ...
                inflate(R.layout.item_list_t, viewGroup, false);
