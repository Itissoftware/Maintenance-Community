...
public class GetLogErrorRecyclerAdapter extends RecyclerView.Adapter<GetLogErrorRecyclerAdapter.ContactViewHolder> {

    Context context;
    ArrayList<GetLog> list = new ArrayList<>();
    public static OnItemClickListener mItemClickListener;

    public GetLogErrorRecyclerAdapter(Context context, ArrayList<GetLog> list) {
    ...
    public void onBindViewHolder(ContactViewHolder contactViewHolder, int i) {
        GetLog item = list.get(i);
        contactViewHolder.title_tv.setText(item.getMovie().get(i).getDeatails());
